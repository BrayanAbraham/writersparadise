...
import { addShortStory } from "../../actions/shortStoryActions";
...
class CreateShort extends Component {
  constructor(props) {
    super(props);
    this.state = {
      title: "",
  ...
  onSubmit(e) {
    ...
    this.props.addShortStory(newShort, this.props.history);
  }
...
CreateShort.propTypes = {
  addShortStory: PropTypes.func.isRequired,
