...
import { getPoem, editPoem } from "../../actions/poemActions";
...
class EditPoem extends Component {
  ...
  componentWillReceiveProps(newProps) {
    ...
    if (newProps.poem.poem) {
      const { poem } = newProps.poem;
      this.setState({
        title: poem.title,
        status: poem.status,
        allowComments: poem.allowComments,
        body: poem.body
      });
    }
  }
  ...
  onSubmit(e) {
    ...
    this.props.editPoem(newPoem, this.props.poem.poem._id, this.props.history);
  }
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-10 m-auto">
              <h1 className="display-4 text-center">Edit Poem</h1>
